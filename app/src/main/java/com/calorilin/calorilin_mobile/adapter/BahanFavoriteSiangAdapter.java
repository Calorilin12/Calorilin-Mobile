...
public class BahanFavoriteSiangAdapter extends RecyclerView.Adapter<BahanFavoriteSiangAdapter.ViewHolder> {
    ...
    public BahanFavoriteSiangAdapter(Context context, List<MaterialfavtimeshowItem> list){
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        dataControlTotal.tambahtotalSiang(foodMaterialsItem.getCalory());

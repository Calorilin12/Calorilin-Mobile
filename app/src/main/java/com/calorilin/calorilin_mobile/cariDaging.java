...
public class cariDaging extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cari_daging);

        cari = findViewById(R.id.caridaging);
        ...
        call.enqueue(new Callback<List<RecipesItem>>() {
            ...
            public void onResponse(Call<List<RecipesItem>> call, Response<List<RecipesItem>> response) {
                if (response.isSuccessful()) {
                    ...
                    Toast.makeText(cariDaging.this, "Berhasil", Toast.LENGTH_LONG).show();
                    carimakanan = findViewById(R.id.tampilcarimakanandaging);

                    CariAdapter adapter2 = new CariAdapter(getApplicationContext(), resep);
                    carimakanan.setLayoutManager(new LinearLayoutManager(cariDaging.this, LinearLayoutManager.VERTICAL, false));
                    ...
                    Toast.makeText(cariDaging.this, "Gagal", Toast.LENGTH_SHORT).show();
                }
            }
            ...
            public void onFailure(Call<List<RecipesItem>> call, Throwable t) {
                ...
                Toast.makeText(cariDaging.this, "Gagal" + t.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });

        back = findViewById(R.id.img_back_daging);

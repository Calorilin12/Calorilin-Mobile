...
public class cariBuah extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cari_buah);

        cari = findViewById(R.id.caribuah);
        ...
        call.enqueue(new Callback<List<RecipesItem>>() {
            ...
            public void onResponse(Call<List<RecipesItem>> call, Response<List<RecipesItem>> response) {
                if (response.isSuccessful()) {
                    ...
                    Toast.makeText(cariBuah.this, "Berhasil", Toast.LENGTH_LONG).show();
                    carimakanan = findViewById(R.id.tampilcarimakananbuah);

                    CariAdapter adapter2 = new CariAdapter(getApplicationContext(), resep);
                    carimakanan.setLayoutManager(new LinearLayoutManager(cariBuah.this, LinearLayoutManager.VERTICAL, false));
                    ...
                    Toast.makeText(cariBuah.this, "Gagal", Toast.LENGTH_SHORT).show();
                }
            }
            ...
            public void onFailure(Call<List<RecipesItem>> call, Throwable t) {
                ...
                Toast.makeText(cariBuah.this, "Gagal" + t.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });

        back = findViewById(R.id.img_back_buah);

...
public class cariSayur extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cari_sayur);

        cari = findViewById(R.id.carisayur);
        ...
        call.enqueue(new Callback<List<RecipesItem>>() {
            ...
            public void onResponse(Call<List<RecipesItem>> call, Response<List<RecipesItem>> response) {
                if (response.isSuccessful()) {
                    ...
                    Toast.makeText(cariSayur.this, "Berhasil", Toast.LENGTH_LONG).show();
                    carimakanan = findViewById(R.id.tampilcarimakanansayur);

                    CariAdapter adapter2 = new CariAdapter(getApplicationContext(), resep);
                    carimakanan.setLayoutManager(new LinearLayoutManager(cariSayur.this, LinearLayoutManager.VERTICAL, false));
                    ...
                    Toast.makeText(cariSayur.this, "Gagal", Toast.LENGTH_SHORT).show();
                }
            }
            ...
            public void onFailure(Call<List<RecipesItem>> call, Throwable t) {
                ...
                Toast.makeText(cariSayur.this, "Gagal" + t.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });

        back = findViewById(R.id.img_back_sayur);

...
public class cariMinuman extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cari_minuman);

        cari = findViewById(R.id.cariminuman);
        ...
        Call<List<RecipesItem>> call = methods.recipesCatagoryResponse("Bearer " + token,"Minuman");
        ...
        call.enqueue(new Callback<List<RecipesItem>>() {
            ...
            public void onResponse(Call<List<RecipesItem>> call, Response<List<RecipesItem>> response) {
                if (response.isSuccessful()) {
                    ...
                    Toast.makeText(cariMinuman.this, "Berhasil", Toast.LENGTH_LONG).show();
                    carimakanan = findViewById(R.id.tampilcarimakananminuman);

                    CariAdapter adapter2 = new CariAdapter(getApplicationContext(), resep);
                    carimakanan.setLayoutManager(new LinearLayoutManager(cariMinuman.this, LinearLayoutManager.VERTICAL, false));
                    ...
                    Toast.makeText(cariMinuman.this, "Gagal", Toast.LENGTH_SHORT).show();
                }
            }
            ...
            public void onFailure(Call<List<RecipesItem>> call, Throwable t) {
                ...
                Toast.makeText(cariMinuman.this, "Gagal" + t.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });

        back = findViewById(R.id.img_back_minuman);
